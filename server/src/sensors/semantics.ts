import { LightCapability, LightProperty, SENSOR_META, SensorType, SirenCapability, SirenProperty } from '@camera.ui/sdk';
...
export function resolveSensorSemantics(sensor: Pick<StoredSensorData, 'type' | 'capabilities'>): SensorSemantics | undefined {
  ...
  if (sensor.type === SensorType.Siren && sensor.capabilities.includes(SirenCapability.Volume)) {
    return { ...base, volume: { property: SirenProperty.Volume, scale: 100 } };
  }
